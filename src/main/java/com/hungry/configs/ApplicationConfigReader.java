...
public class ApplicationConfigReader {
	...
	public String toString() {
		return "ApplicationConfigReader [app1Exchange=" + app1Exchange + ", app1Queue=" + app1Queue
				+ ", app1RoutingKey=" + app1RoutingKey + ", app2Exchange=" + app2Exchange + ", app2Queue=" + app2Queue
				+ ", app2RoutingKey=" + app2RoutingKey + "]";
	}
