...
public class SecurityMaster {
	...
	public String token(TokenStatus status) {
	...
	public TokenStatus status(String token) throws NoSuchAlgorithmException, NoSuchPaddingException,
		...
		try {
			...
			return statusMaster.seek(decrypted);
